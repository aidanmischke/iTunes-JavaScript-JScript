try {
	...
	var albumArtist = "AA MIX";
	var album = albumArtist;
	
	var album2 = "Mischke Mix";
	...
	while (i != tracksCount) {
		...
		// Skip further processing of track it's been processed before.		
		if(currentTrack.AlbumArtist === albumArtist)
			continue;
